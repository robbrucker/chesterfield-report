...
<header class="cr-header masthead">
  ...
  <nav class="topnav cr-header__nav nav-desktop" aria-label="Main navigation">
    ...
    <div class="nav-g"><button class="nav-t" type="button">Investigative <span class="nav-c">&#9662;</span></button><div class="nav-d"><a href="/shoosmith.html">Shoosmith landfill</a></div></div>
  </nav>
