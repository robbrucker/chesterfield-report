...
SOURCES = [
    ...
    # -- Topic-based --
    {
        ...
        "kind": "rss",
        "url": "https://news.google.com/rss/search?q=Chesterfield+rezoning+-Derbyshire+-England&hl=en-US&gl=US&ceid=US:en",
        "geo_filter": True,
        "default_focus": ["growth"],
        "license": "press",
    },
    {
        ...
        "name": "Google News: Chesterfield Development",
        "kind": "rss",
        "url": "https://news.google.com/rss/search?q=Chesterfield+development+-Derbyshire+-England&hl=en-US&gl=US&ceid=US:en",
        "geo_filter": True,
        "default_focus": ["growth"],
        "license": "press",
    },
    {
        ...
        "kind": "rss",
        "url": "https://news.google.com/rss/search?q=Chesterfield+data+center+-Derbyshire+-England&hl=en-US&gl=US&ceid=US:en",
        "geo_filter": True,
        "default_focus": ["growth", "business"],
        "license": "press",
    },
    {
        ...
        "kind": "rss",
        "url": "https://news.google.com/rss/search?q=Chesterfield+restaurant+-Derbyshire+-England&hl=en-US&gl=US&ceid=US:en",
        "geo_filter": True,
        "default_focus": ["business"],
        "license": "press",
    },
    {
        ...
        "kind": "rss",
        "url": "https://news.google.com/rss/search?q=Chesterfield+crime+-Derbyshire+-England&hl=en-US&gl=US&ceid=US:en",
        "geo_filter": True,
        "default_focus": ["police"],
        "license": "press",
    },
