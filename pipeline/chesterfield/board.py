...
def build_board():
    ...
    intro = (
        ...
        '<p class="lead" style="font-size:.98rem;">See '
        '<a href="/taxes.html">Where Your Taxes Go</a> for a plain-language look at '
        'the county budget the Board sets: where the money comes from, where it '
        'goes, and the current tax rates.</p>'
